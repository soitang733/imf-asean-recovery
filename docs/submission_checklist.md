...
|---|---|---|
| Final data product | `app.py` | Complete |
| Reproducible Python code | `src/`, `run_pipeline.py` | Complete |
| IMF raw data | `data/raw_imf_weo.xml` | Complete |
...
| Presentation and defense | `docs/presentation_script.md` | Complete |
| QR code for printed product | Link deployed app/repository | Pending deployment |
